...
import org.example.hospitalManagement_SpringSecurity.dtos.BloodGroupCountResponseEntity;
...
public interface PatientRepository extends JpaRepository<Patient, Long> {
   ...
   /* @Query("select new org.example.hospitalManagement_SpringSecurity.dtos.BloodGroupCountResponseEntity(p.bloodGroup," +
